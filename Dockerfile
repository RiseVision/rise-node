...
COPY --chown=rise ./packages/core-multisignature/package.json ./packages/core-multisignature/package.json
...
ENV NETWORK="mainnet"
EXPOSE 5555
CMD ./node_modules/.bin/lerna run start:$NETWORK -- -e /home/rise/config.json
