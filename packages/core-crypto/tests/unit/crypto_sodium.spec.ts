...
describe('helpers/crypto(sodium)', () => {
  let proxiedInst: Crypto;
  const ProxiedEd = proxyquire('../../src/crypto_sodium', {
    sodium: sodiumStub,
  });
  ...
  describe('makeKeyPair', () => {
    ...
    beforeEach(() => {
      stub = sinon
        .stub(sodium.api, 'crypto_sign_seed_keypair')
  ...
  describe('verify', () => {
    ...
    beforeEach(() => {
      stub = sinon
        .stub(sodium.api, 'crypto_sign_verify_detached')
        .returns(true);
    });
