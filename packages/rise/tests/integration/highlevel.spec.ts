...
describe('highlevel checks', function() {
  ...
  //       transactions = [
  //         await createSendTransactionV1(1, 1, senderAccount, otherAccounts.wallet.address),
  //         await createVoteTransactionV1(1, senderAccount, otherAccounts.delegate.publicKey, true),
  //       ];
