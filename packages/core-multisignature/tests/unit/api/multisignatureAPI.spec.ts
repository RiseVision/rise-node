...
import { IAccountsModule, ITransactionLogic, ITransactionPool, Symbols } from '@risevision/core-interfaces';
import { Accounts2MultisignaturesModel } from '../../../src/models';
import { createContainer } from '@risevision/core-launchpad/tests/unit/utils/createContainer';
import { AccountsModelWithMultisig, MultiSignaturesApi, MultisigSymbols } from '../../../src';
        ...
        transactions: [
          {
            ...
            min        : 2,
            signed     : true /* stub */,
            transaction: { ...tx1, senderPublicKey: tx1.senderPublicKey.toString('hex') }
          },
          {
            lifetime   : 101,
            max        : 0,
            ...
            transaction: { ...tx3, senderPublicKey: tx3.senderPublicKey.toString('hex') }
          },
          {
            lifetime   : 301,
            max        : 0,
            min        : 302,
            signed     : true,
            transaction: { ...tx4, senderPublicKey: tx4.senderPublicKey.toString('hex') }
          },
        ],
      });
    });
