...
describe("modules/blocks", function() {
    ...
    describe("constructor", function() {
        ...
        it("blocksProcess creation", function() {
            ...
            expect(blocksProcess.getCall(0).args[3]).to.equal(scope.logic.transaction);
        ...
        it("callback", function() {
            ...
            expect(blocksChainEntity.saveGenesisBlock.getCall(0).args.length).to.equal(1);
            expect(blocksChainEntity.saveGenesisBlock.getCall(0).args[0]).to.be.a("function");
    ...
    describe("blocks.lastBlock", function() {
        ...
        it("isFresh returns true", function() {
            ...
            __private.lastBlock = {
                timestamp : Math.floor(Date.now() / 1000) - (Math.floor(constants.epochTime / 1000))
            };
    ...
    describe("blocks.sandboxApi", function() {
        it("sandbox.callMethod", function() {
            ...
            expect(sandboxHelper.callMethod.getCall(0).args[0]).to.equal(blocksModule.prototype.shared);
    ...
    describe("blocks.cleanup", function() {
        ...
        it("isActive = false, next wait, next false", function() {
            ...
            expect(scope.logger.info.getCall(0).args[0]).to.equal("Waiting for block processing to finish...");
