...
describe("modules/accounts", function() {
    ...
    it("public.onBind", function() {
        ...
        scope.logic.transaction.attachAssetType = function(){};
        sinon.stub(scope.logic.transaction, "attachAssetType");
        ...
        expect(assetFakeBind.getCall(0).args.length).to.equal(1);
        expect(assetFakeBind.getCall(0).args[0]).to.have.property("modules", testScope);
        expect(assetFakeBind.getCall(0).args[0]).to.have.property("library", scope);
    });
