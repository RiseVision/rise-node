...
describe('modules/cache', () => {
  ...
  describe('DummyCache', () => {
    ...
    it('.deleteJsonForKey should rejected with Cache not enabled msg', async () => {
      ...
      await expect(dummyCache.deleteJsonForKey(str)).to.rejectedWith('Cache not enabled');
    });
    ...
    it('.deleteJsonForKey should rejected with Cache not enabled msg', async () => {
      ...
      await expect(dummyCache.getObjFromKey(str)).to.rejectedWith('Cache not enabled');
    });
