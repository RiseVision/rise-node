...
describe("logic/block", function() {
    ...
    describe("When we call to...", function(){
        var callback, transaction, block, data;
        ...
        describe("create()", function(){
            it("...should be return a new block", function(){
                expect(callback.called).to.be.true;
        ...
        describe("sign()", function(){
            it("...should be return a block signature with 128 of lenght", function(){
                expect(callback.called).to.be.true;
                var instance = callback.args[0][1];
        ...
        describe("getBytes()", function(){
            it("...should be return a Buffer", function(){
                var instance = callback.args[0][1];
        ...
        describe("verifySignature()", function(){
            it("...should be return a verified hash", function(){
                var instance = callback.args[0][1];
