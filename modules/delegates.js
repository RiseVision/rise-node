...
var Delegate = require('../logic/transactions/delegate').RegisterDelegateTransaction;
...
__private.forge = function (cb) {
	...
	var lastBlock = modules.blocks.lastBlock;
	...
	__private.getBlockSlotData(currentSlot, lastBlock.height + 1, function (err, currentBlockData) {
		...
		library.sequence.add(function (cb) {
			...
			if (err) {
				...
				var forgedBlock = modules.blocks.lastBlock;
...
Delegates.prototype.shared = {
	...
	getNextForgers: function (req, cb) {
		var currentBlock = modules.blocks.lastBlock;
