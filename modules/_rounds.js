 ...
 */
Rounds.prototype.isLoaded = function () {
 ...
 */
Rounds.prototype.isTicking = function () {
 ...
 */
Rounds.prototype.calcRound = function (height) {
 ...
 *
 */
Rounds.prototype.flush = function (round) {
  return library.db.none(sql.flush, { round: round }).then(function () {
 ...
 */
Rounds.prototype.backwardTick = function (block, previousBlock) {
  var round     = self.calcRound(block.height);
  var prevRound = self.calcRound(previousBlock.height);
  var nextRound = self.calcRound(block.height + 1);
...
// Export
module.exports.RoundsModule = Rounds;
