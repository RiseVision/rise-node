...
import {TransactionPool} from '../logic/transactionPool';
import {IBaseTransaction, IConfirmedTransaction} from '../logic/transactions/baseTransactionType';
import {SendTransaction} from '../logic/transactions/send';
...
export class TransactionsModule {
  ...
  constructor(public library: TransactionLibrary) {
    this.transactionPool = new TransactionPool(
      this.library.config.broadcasts.broadcastInterval,
      this.library.config.broadcasts.releaseLimit,
